...
const latestPinpointRegions = FeatureFlags.getBoolean('latestRegionSupport.pinpoint');
...
const serviceRegionMap = {
  ...
  'us-east-2': 'us-east-1',
  'sa-east-1': 'us-east-1',
  'ca-central-1': latestPinpointRegions ? 'ca-central-1' : 'us-east-1',
  'us-west-1': 'us-west-2',
  'us-west-2': 'us-west-2',
  'cn-north-1': 'us-west-2',
  'cn-northwest-1': 'us-west-2',
  'ap-south-1': latestPinpointRegions ? 'ap-south-1' : 'us-west-2',
  'ap-northeast-3': 'us-west-2',
  'ap-northeast-2': latestPinpointRegions ? 'ap-northeast-2' : 'us-west-2',
  'ap-southeast-1': latestPinpointRegions ? 'ap-southeast-1' : 'us-west-2',
  'ap-southeast-2': latestPinpointRegions ? 'ap-southeast-2' : 'us-west-2',
  'ap-northeast-1': latestPinpointRegions ? 'ap-northeast-1' : 'us-west-2',
  'eu-central-1': 'eu-central-1',
  'eu-west-1': 'eu-west-1',
  'eu-west-2': latestPinpointRegions ? 'eu-west-2' : 'eu-west-1',
  'eu-west-3': 'eu-west-1',
};
